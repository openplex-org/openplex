...
void LevelDecoder::loadLevel(GameContext &gameContext, const uint8_t *levdat) {
  ...
  const size_t LevelDataLayoutInfotronsRequirement = 1470;
  const size_t LevelDataLayoutGravity = 1444;
  if (levdat[1470]) {
